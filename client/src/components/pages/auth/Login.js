        ...
        <div className="auth">
            <div className="login_page">
                <div className="top_part_auth">
                    ...
                    <div className="auth_forms">
                        <div className="registration_options">
                            <div className="reg_options_buttons">
                                <button><i className="fa fa-google" aria-hidden="true"></i> Continuue with Google</button>
                                <button><i className="fa fa-facebook-official" aria-hidden="true"></i> Continue with Facebook</button>
                            </div>
                            <p><Link to="/register">Sign up with Email.</Link> By continuing you indicate that you have read and
                    agree to Quora's <Link to="!#">Terms of Service</Link> and <Link to="!#">Privacy Policy.</Link></p>
                        </div>
                        <div className="login">
                            <form onSubmit={loginSubmit}>
                                ...
                                <div>
                                    ...
                                    value={user.passwordy} onChange={onChangeInput}
                                    />
                                </div>
                ...
                <div className="auth_footer">
                    <div className="a_l_layer">
                        <ul>
                            <li>New:</li>
                            <li>Arabic, Telugu, Hebrew, Kannada, Malayalam, Gujurati, and Polish</li>
                        </ul>
                    </div>
                    <div className="a_l_layer">
                        <ul>
                            ...
                            <li>Terms</li>
                            <li>Contact</li>
                            <li> <i class="fa fa-copyright" aria-hidden="true"></i> Quora Inc. 2020</li>
                        </ul>
                    </div>
                </div>
            </div>
